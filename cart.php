...
<body>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-sm-6 pr-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="alamat" id="NAME" aria-describedby="helpId" placeholder="Alamat ">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="NAME" class="small text-muted mb-1">KODE POS KOTA ANDA</label>
                                                <input type="text" class="form-control form-control-sm" name="NAME" id="NAME" aria-describedby="helpId" placeholder="0xxxx">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-md-5">
                                        <div class="col">
                                            <input type="submit" name="beli" value="BELI" class="btn  btn-lg btn-block"></input>
                                        </div>
                                    </div>
    ...
    <style>
        body {
            background: linear-gradient(110deg, black 60%, grey 60%);
        }
