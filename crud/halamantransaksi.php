...
if(isset($_POST['simpan'])){
    ...
    if($id_transaksi && $id_pembeli && $id_barang && $total){

        if($op=='edit'){
            $sql1="update transaksi set id_transaksi='$id_transaksi',id_pembeli='$id_pembeli',id_barang='$id_barang',total='$total' where id_transaksi='$id_transaksi' ";
            $q1=mysqli_query($koneksi,$sql1);
            if($q1){
            ...
            $sql1="insert into transaksi(id_transaksi,id_pembeli,id_barang,total) values ('$id_transaksi','$id_pembeli','$id_barang','$total')";
        $q1=mysqli_query($koneksi,$sql1);
        if($q1){
